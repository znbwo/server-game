...
sqlclient.init = function(app)
{
    ...
    else
    {
        ...
        var options =
        {
            ...
            'port': mysqlConfig.gameUser.port,
            'user': mysqlConfig.gameUser.user,
            'password': mysqlConfig.gameUser.password,
            'database': mysqlConfig.gameUser.database,
            'charset': mysqlConfig.gameUser.charset,
            'connectionLimit': mysqlConfig.gameUser.maxConnLimit,
